...
from alignak_app.widgets.dialogs.user_options_dialog import show_options_dialog
from alignak_app.widgets.dialogs.token_dialog import TokenQDialog
from alignak_app.widgets.dialogs.password_dialog import PasswordQDialog
